...
namespace App\WalletModule\Money;

use App\WalletModule\Money\Calculator\CalculatorInterface;
use App\WalletModule\Money\Calculator\PhpCalculator;
use App\WalletModule\Money\Traits\HasFormatters;
use App\WalletModule\Money\Traits\MoneyFactory;
use Closure;
...
class Money implements \JsonSerializable
{
    ...
    /**
     * @var \App\WalletModule\Money\Calculator\CalculatorInterface
     */
    ...
    /**
     * @param \App\WalletModule\Money\Money $other
     *
     * @return bool
     */
     ...
     * @return array
     */
    public function json(?Closure $callback = null): array
    {
