...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | By default, WalletModule uses auto-incrementing primary keys when assigning
    | IDs to clients. However, when installing WalletModule you will be asked
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | By default, WalletModule use Illuminate\Support\Str::orderedUuid() to generate
